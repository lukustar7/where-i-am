...
- Fixed SVG compass dial and vehicle heading needle rotation pivot offset caused by redundant CSS `transform-box` and `transform-origin` rules, restoring concentric alignment with the readout text.
- Bumped Service Worker offline cache version to `where-i-am-v1.7.1`.
